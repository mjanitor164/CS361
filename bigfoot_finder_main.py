...
def create_GUI():
    ...
    def displaySightingData():
        ...
        alaskaSightingData = {'Borough':['Anchorage','Bethel','Bristol Bay','Cordova', 'Kenai-Cook Inlet'],
        'Number of Listings':['2','2','1','1', '1'],
        'Most Recent Report':['2-2004','9-1998','7-2004','6-2000', '11-1985'],
        'Last Posted':['11-2005','1-2013','5-2005','11-2000', '12-1998']}
        ...
        dataTable = TableView(alaskaSightingData, 4, 4)
    ...
    news_three = QLabel("BFRO UPDATES @BFRO_Updates--10/13\nJust posted on BFRO web site:\nSept 22, 2021 ; Texas (Marion County)\n"
        "Northeast corner of the state, near Lousiana\n border. Class B sighting by motorist in morning \ndaylight.\nFor details and Google Maps pin see report here:\n"
        "http://bfro.net/GDB/show_report.asp?id=70712\nDiscussion: https://bit.ly/3mN8F9l")
